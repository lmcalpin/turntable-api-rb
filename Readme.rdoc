...
This is currently incomplete.  To get an idea of the available actions you can invoke using the API, you should
refer to my {Scala version of this API}[https://github.com/lmcalpin/turntable-api-scala], which is complete.
...
to the client, and that is what it is called in the json payload we receive from the server.)
